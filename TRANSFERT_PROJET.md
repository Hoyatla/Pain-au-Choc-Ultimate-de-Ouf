...
- Durcissements autopilot (maj 2026-03-23):
  ...
  - resume autopilot enrichi: `cached_candidate_is_fresh`, `cached_candidate_eligible_for_use`, `cached_candidate_freshness_status`, `decision_freshness` detaille en cas de `candidate_build_failed`, inventaire des gates CI actives (`active_fail_gate_count`, `active_fail_gates`) et des gates effectivement declenchees (`triggered_fail_gate_count`, `triggered_fail_gates`).
- Lecture du resultat:
