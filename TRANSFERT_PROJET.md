...
- Durcissements autopilot (maj 2026-03-23):
  ...
  - export machine-readable disponible: `-SummaryOutputPath <fichier.json>` (`summary_output_compressed`, `summary_output_write_mode`, `summary_output_written/written_utc/error` dans le resume; mode compact via `-SummaryOutputCompress`), ecriture atomique pour eviter les JSON partiels.
