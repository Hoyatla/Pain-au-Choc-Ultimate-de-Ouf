...
public class ProcessRunner {
	...
	// Some upstream code only needs uname-style environment hints. Keep that
	// compatibility surface without ever spawning an external process.
	...
	private static String getProcessOutput(Process ignoredProcess) {
		return "";
	}
