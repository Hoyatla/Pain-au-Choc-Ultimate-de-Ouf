...
public final class CommonUniforms {
	...
	public static void generalCommonUniforms(UniformHolder uniforms, FrameUpdateNotifier updateNotifier, PackDirectives directives) {
		...
		uniforms
			...
			.uniform1i(PER_FRAME, "dhRenderDistance", DHCompat::getShaderRenderDistance)
			.uniform1f(PER_FRAME, "paucLodFarPlane", DHCompat::getFarPlane)
			.uniform1f(PER_FRAME, "paucLodNearPlane", DHCompat::getNearPlane)
			.uniform1i(PER_FRAME, "paucLodRenderDistance", DHCompat::getShaderRenderDistance)
			.uniform1i(PER_FRAME, "paucEmbeddedDh", () -> DHCompat.isUsingPauCEmbeddedBridgeOnly() ? 1 : 0)
			.uniform1i(PER_FRAME, "paucShaderPresentationEnabled", PauCLodShaderPresentation::shaderPresentationEnabled)
