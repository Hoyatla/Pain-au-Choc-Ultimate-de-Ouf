...
public class IrisInternalUniforms {
	...
	public static void addFogUniforms(DynamicUniformHolder uniforms, FogMode fogMode) {
		...
		uniforms.uniform1f(PER_FRAME, "iris_FogStart", () -> PauCLodShaderPresentation.shaderFogStartBlocks(RenderSystem.getShaderFogStart()))
			.uniform1f(PER_FRAME, "iris_FogEnd", () -> PauCLodShaderPresentation.shaderFogEndBlocks(RenderSystem.getShaderFogEnd()));
