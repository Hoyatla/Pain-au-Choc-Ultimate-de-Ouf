...
public class IrisSamplers {
	...
	public static void addRenderTargetSamplers(SamplerHolder samplers, Supplier<ImmutableSet<Integer>> flipped,
		...
		// Keep the legacy DH sampler names for shaderpack compatibility while exposing PauC-owned aliases.
		samplers.addDynamicSampler(TextureType.TEXTURE_2D, () -> pipeline.getDHCompat().getDepthTex(), null, "paucLodDepthTex", "paucLodDepthTex0", "dhDepthTex", "dhDepthTex0");
		samplers.addDynamicSampler(TextureType.TEXTURE_2D, () -> pipeline.getDHCompat().getDepthTexNoTranslucent(), null, "paucLodDepthTex1", "dhDepthTex1");
	}
