...
public class IrisVideoSettings {
	...
	private static boolean loadingFromConfig;
	...
	public static void loadShadowDistanceFromConfig(int distance) {
	...
	private static int sanitizeShadowDistance(int distance) {
		return Math.max(0, Math.min(32, distance));
	}
}
