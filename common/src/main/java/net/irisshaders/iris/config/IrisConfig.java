...
public class IrisConfig {
	...
	public void load() throws IOException {
		...
		try {
			IrisVideoSettings.loadShadowDistanceFromConfig(Integer.parseInt(properties.getProperty("maxShadowRenderDistance", "32")));
			...
			IrisVideoSettings.loadShadowDistanceFromConfig(32);
