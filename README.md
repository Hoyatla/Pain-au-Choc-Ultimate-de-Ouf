...
- `tools/test_autopilot_fail_gates.ps1` execute un lot de non-regression sur les gates error-sorting (baseline + blocking + status + noise_fail) avec rapports JSON dedies sous `run/pauc_reports/autopilot_fail_gate_selftest_*`.
